...
var SHOTS = [
  { d: 7.0, from: [2.78, 1.62], to: [2.62, 1.28], la: [2.05, 2.50, 1.30], lb: [4.05, 0.45, 1.35],
    title: "Прихожая", sub: "5,80 м² · белый шкаф-купе с зеркалом" },
  ...
  { d: 6.5, from: [4.62, 2.75], to: [4.80, 2.35], la: [6.05, 1.20, 1.20], lb: [6.20, 1.35, 1.10],
    title: "Белый угловой гарнитур", sub: "1,47 + 1,93 м · встроенная техника" },
  { d: 6.5, from: [4.35, 2.95], to: [4.25, 3.35], la: [5.35, 4.05, 1.00], lb: [5.55, 4.35, 0.95],
    title: "Обеденная зона", sub: "стол 1100×700 · акценты живыми цветами" },
  { d: 7.5, from: [4.20, 4.95], to: [4.32, 5.60], la: [6.10, 5.25, 1.20], lb: [6.30, 5.85, 1.00],
    title: "Гостиная", sub: "диван 2,0 м · ТВ-зона напротив" },
  ...
  { d: 7.0, from: [2.74, 5.55], to: [2.70, 4.75], la: [0.95, 3.60, 1.35], lb: [1.05, 3.10, 1.60],
    title: "Кровать 1600×2000", sub: "шкаф во всю стену · белые двери" },
  { d: 4.5, from: [2.88, 1.34], to: [2.32, 1.34], la: [0.35, 1.40, 1.35], lb: [0.30, 1.55, 1.20],
    title: "Санузел", sub: "4,50 м² · керамогранит бежевый 600×600", cut: true },
...
function bootRender() {
  ...
  camera.fov = 80;                                          // широкий угол — стандарт для съёмки интерьеров
