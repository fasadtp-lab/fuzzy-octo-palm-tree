...
<div class="card" id="intro">
  ...
  <h1>Квартира № 643</h1>
  <p>1-комнатная, 39,30 м², ул. Родины. Видеообзор с готовым ремонтом: светлые телесные обои, тёмный ламинат, бежевый керамогранит, арки вместо межкомнатных дверей.</p>
</div>
<div class="card" id="outro">
  ...
  <ul>
    ...
    <li><i style="background:#F5F4F1"></i>Белые рамы, арки без дверей</li>
